...
$city = "Казань";
$email = "igoole.g@mail.ru";
$phone = "+79520378989";
$experience = [
[
    	'name' => 'Cross-functional manager',
        'date start' => 'March 2020',
        'date end'=> 'Current',
        'description' => 'Managing ITSM, doing something, rfkzvedfbhjgjh',
],
[
    	'name' => 'Customer success manager',
        'date start' => 'February 2019',
        'date end'=> 'March 2020',
        'description' => 'А тут будет описание',
],
[
    	'name' => 'Personal assistant',
        'date start' => 'June 2018',
        'date end'=> 'February 2019',
        'description' => 'Тут была работа с Петром',
],
]
?>
<!DOCTYPE html>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <?php echo $experience[$i]['date start'];?> - 
            <?php if ($i == 0): ?>
            <span class="w3-tag w3-teal w3-round">
            <?php echo $experience[$i]['date end'];?></span>
            <?php else: ?> 
            <?php echo $experience[$i]['date end'];?>
            <?php endif;?>
            </h6>
